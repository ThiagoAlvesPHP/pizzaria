            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">SOBRE</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">CARDÁDIO</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#team">CONTATO</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">PEDIDO</a></li>
                    </ul>
                </div>
            </div>
        </nav>
